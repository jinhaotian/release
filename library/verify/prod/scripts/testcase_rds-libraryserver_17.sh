...
HEADER= -H "x-rds-devkey: 4B8C5B7B5B7B5I4H" -H "x-rds-login: qa_4shbme@rhapsody.lan" -H "Content-Type: application/xml" -H "x-rds-cobrand: 40134" -H "x-rds-authentication: rhap123"
